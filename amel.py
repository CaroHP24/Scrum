...
def final_treatement():
        # Tache de Lucas, à implémenter: 
        #      - Écrire les 3 infos dans le bon format
        #      - Nom de fichier = nom PDF avec _ à la place des espaces
    ...
    for fich in os.listdir(TMP_TXT_DIR):
            ...
            # Générer le fichier final, ici j'ai remis le meme .txt juste pour le test de la mise en dossier final
            fichFinal = fich  
            ...
            with open(chemin_sortie, "w", encoding="utf-8") as f:
                f.write("Contenu du fichier .txt final....\n")
